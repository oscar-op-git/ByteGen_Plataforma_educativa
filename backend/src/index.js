...
var FRONTEND_ORIGIN = (_a = process.env.FRONTEND_ORIGIN) !== null && _a !== void 0 ? _a : "http://localhost:5173";
...
app.use("/api/auth", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                ...
                body = null;
                if (hasBody) {
                    ct = (req.headers["content-type"] || "").toLowerCase();
                    if (ct.includes("application/x-www-form-urlencoded")) {
                        ...
                        body =
                            typeof req.body === "string"
                                ? req.body
                                : JSON.stringify((_e = req.body) !== null && _e !== void 0 ? _e : {});
                        if (!headers.get("content-type")) {
                ...
                request = new Request(url, {
                    method: req.method,
                    headers: headers,
                    body: body, // BodyInit | null (nunca undefined)
                    redirect: "manual",
                });
